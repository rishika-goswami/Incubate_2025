...
add_selectbox = st.sidebar.selectbox(
    "Pages",
    ("About KAVACH", "Interactive Dashboard", "Decision Support Tool")
)

# Home Page
if add_selectbox=='About KAVACH':
    st.markdown("""
    <style>
    .big-font {
    ...
    # Page Description
    st.title('Predictive Analysis of AMR Trends For Healthcare Decision Making And Forecasting (KAVACH)')

    st.title('What is KAVACH?')
    st.markdown('KAVACH is a two-tiered interactive dashboard application capable of presenting evolving \
    ...
    st.title("KAVACH's Functionality")
    st.markdown('The KAVACH interactive dashboard presents global antimicrobial resistance (AMR) data from the \
    ...
    st.divider()
    st.markdown('The KAVACH decision support tool presents a web-based, open BLAST (Basic Local Alignment Search Tool) \
...
# Dashboard Page    
    ...
    st.title('KAVACH Interactive Dashboard')
    st.divider()
...
# Decision Support page
    ...
    st.title('KAVACH Decision Support Tool')
    # Page Description
    st.markdown("The KAVACH decision support tool runs a BLAST (Basic Local Alignment Search Tool) pipeline \
